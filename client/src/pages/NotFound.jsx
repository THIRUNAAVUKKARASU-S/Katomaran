    ...
    <div className={`min-h-screen flex items-center justify-center px-4 transition-colors duration-300 ${
      ...
      >
        <div className="relative inline-flex mb-6">
          <div className="p-4 bg-amber-500/10 text-amber-500 rounded-full shadow-lg shadow-amber-500/5">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight mb-3">Link Not Found</h1>
        <p className="text-sm text-slate-400 dark:text-slate-400 mb-8 max-w-sm mx-auto">
          The link short code or URL you requested could not be resolved. Please verify the address and try again.
        </p>
